...
app.controller('MyCtrl', function ($scope, $window, $http, $uibModal) {
	...
	vm.search = function () {
		...
		var req2 = {
			method: "GET",
			url: "https://api.edamam.com/api/recipes/v2?type=public&q=" + vm.searchText + "&app_id=a67e38e4&app_key=844b3c11bfda214a5e7de475d42c621f&to=1000" + vm.fil + vm.label + vm.kalorijeOdDo + vm.maxI
		}
		$http(req2).then(
